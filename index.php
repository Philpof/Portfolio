...
<!-- Section 1 A propos-->
<section id="section1" class="container pb-5">

  <!-- Titre -->
  <h1 id="titre" class="text-light">Philippe Perechodov</h1>
  <h5 id="sstitre" class="text-light font-italic">- Developpeur Web -</h5>

  <!-- Navbar -->
  <div class="icon-bar col-sm-10 col-md-8 col-lg-6 d-flex flex-column text-center">
  ...
  <!-- <ul class="nav">
    ...
    <a class="nav-link text-light" href="index.php#section2">Projets & Réalisations</a>
...
<div id="section2" class="container text-light">
  ...
  <div class="projets">
    ...
    <div class="box">
      <a href="noWay.php"><img src="img/BomberLink.png">
      <span>BomberLink</span></a>
    </div>
  </div>
</div>
<div class="progress" id="progress">
...
<!-- Section 4 : Contact-->
<div id="section4" class="container text-light">
...
<!-- Footer -->
<section>
  <div id="footer" class="container text-center text-light pt-3 pb-3">
    <div>
      <div class="icon-bar col-sm-12 d-flex flex-column container-fluid justify-content-center">
